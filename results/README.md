# Results Kept for Report

This folder only contains the final result summaries used in the report.

Files:

- `table2_local_full.csv`
- `table2_local_full_deviation.md`
- `table2_llamaguard_8bit_full.csv`
